...
(defun hoppla/gui-fonts ()
  (set-face-attribute 'default nil :font hoppla/default-font :height hoppla/default-font-size)
  (set-face-attribute 'fixed-pitch nil :font hoppla/default-font :height hoppla/default-font-size)
  (set-face-attribute 'variable-pitch nil :font hoppla/default-variable-font :height hoppla/default-font-size))

(add-to-list 'initial-frame-alist `(font . ,hoppla/default-font))
